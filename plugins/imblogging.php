...
/**
* $Id: smartsection.php 1447 2008-04-06 04:41:21Z malanciault $
* Module: SmartClone
...
/**
 * SmartClone plugin for imBlogging
 */
$i = 0;

$pluginPatterns[$i]['key'] = '_IMBLOGGING_';
$pluginPatterns[$i]['replacement'] = 'CONSTANT';
$pluginPatterns[$i]['prefix'] = '_';
$pluginPatterns[$i]['suffix'] = '_';
$i++;

$pluginPatterns[$i]['key'] = 'imBlogging';
$pluginPatterns[$i]['replacement'] = 'ModuleName';
$i++;
